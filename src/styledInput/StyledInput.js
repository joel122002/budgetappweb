    ...
    return (
        <div className="input-wrapper">
            <div className="form__div">
                <input ref={inputRef} onChange={onValueChanged} value={prop.value} name={prop.name} type={prop.type}
                       className="form__input" placeholder=" "></input>
                <label htmlFor="" className="form__label">{prop.placeholder}</label>
                {prop.showDelete ? <svg className="delete-icon" xmlns="http://www.w3.org/2000/svg"
